...
//            System.out.println(daoSkill.read(5));
//
...
//            Project project1 = daoProject.read(1).get();
//        project1
//                .addDeveloperWithSalary(
//                        getDeveloperInstance(),2558);
...
//            developer5.setId(6);
//            developer5.setName("ffghuj");
//            daoDeveloper.update(developer5);
//
//            System.out.println(daoDeveloper.read(4));
