...
//            daoProject.delete(daoProject.read(2).get());
//
//
...
//            //http://docs.jboss.org/hibernate/orm/5.2/userguide/html_single/Hibernate_User_Guide.html#pc-remove
            Developer developer = new Developer("ffghuj","DeveloperLastname13");
            developer.setId(4);
            daoDeveloper.delete(developer);
//
//           //TODO 3. Теперь все ок. Не понятно, почему было ->  Опять таки здесь я могу удалить developer со skills и projects только, если функция read вызывает getReference,
